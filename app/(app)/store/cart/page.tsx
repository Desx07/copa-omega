  ...
  if (orderCreated) {
    return (
      <div className="min-h-screen">
        <div className="relative bg-gradient-to-b from-omega-green/15 via-omega-surface to-omega-black rounded-b-3xl shadow-lg overflow-hidden">
          <div className="absolute inset-0 bg-grid opacity-20" />
          <div className="relative px-4 pt-10 pb-10 max-w-lg mx-auto">
            <div className="omega-card-elevated shadow-md p-8 text-center space-y-4">
              <div className="size-16 rounded-full bg-omega-green/10 border border-omega-green/30 flex items-center justify-center mx-auto shadow-sm">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <Link
                  href="/store"
                  className="omega-btn omega-btn-primary w-full px-4 py-3 text-sm shadow-lg shadow-omega-purple/20"
                >
      ...
      <div className="relative bg-gradient-to-b from-omega-purple/20 via-omega-surface to-omega-black rounded-b-3xl shadow-lg shadow-omega-purple/5 overflow-hidden">
        ...
        <div className="relative px-4 pt-6 pb-6 max-w-lg mx-auto">
          <div className="flex items-center gap-3">
            <Link
              href="/store"
              className="omega-btn omega-btn-secondary size-10 !p-0 shadow-sm hover:shadow-md"
          ...
          <div className="space-y-4">
            ...
            <div className="omega-card shadow-sm">
              <div className="omega-section-header">
                <ShoppingBag className="size-4 text-omega-purple" />
              ...
              <div>
                {items.map((item) => (
                  <div
                    key={item.product_id}
                    className="omega-row border-l-4 border-l-transparent hover:border-l-omega-purple/50"
                  >
                    {/* Image */}
                    <div className="size-14 rounded-xl bg-omega-dark border border-omega-border/30 overflow-hidden shrink-0 shadow-sm">
                      {item.image_url ? (
                        <img
                          src={item.image_url}
                          alt={item.name}
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        className="omega-btn omega-btn-secondary size-8 !p-0 !rounded-lg shadow-sm"
                      >
            ...
            {/* Payment method */}
            <div className="omega-card shadow-sm p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`flex items-center gap-2 omega-card p-3 transition-all cursor-pointer border-l-4 shadow-sm hover:shadow-md ${
                    paymentMethod === "cash"
                      ? "border-l-omega-green !border-t-omega-green/30 aura-gold"
                      : "border-l-transparent hover:bg-omega-card-hover"
                  }`}
                >
                  <Banknote
                    className={`size-5 ${
                ...
                <button
                  ...
                  className={`flex items-center gap-2 omega-card p-3 transition-all cursor-pointer border-l-4 shadow-sm hover:shadow-md ${
                    paymentMethod === "transfer"
                      ? "border-l-omega-blue !border-t-omega-blue/30 aura-silver"
                      : "border-l-transparent hover:bg-omega-card-hover"
                  }`}
                >
                  <CreditCard
              ...
              {paymentMethod === "transfer" && (
                <div className="space-y-2 pt-2">
                  ...
                  {proofPreview ? (
                    <div className="relative rounded-xl overflow-hidden border border-omega-blue/30 bg-omega-dark shadow-sm">
                      <img
                        src={proofPreview}
                        alt="Comprobante"
                      ...
                      <button
                        type="button"
                        onClick={removeProof}
                        className="absolute top-2 right-2 size-7 rounded-full bg-omega-red/90 flex items-center justify-center text-white hover:bg-omega-red transition-colors shadow-sm"
                      >
                        <Trash2 className="size-3.5" />
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="omega-btn omega-btn-secondary w-full px-4 py-5 border-dashed !border-2 shadow-sm hover:shadow-md"
                    >
            ...
            {/* Notes */}
            <div className="omega-card shadow-sm p-4 space-y-2">
              <label
                htmlFor="notes"
            ...
            <button
              ...
              className="omega-btn omega-btn-green w-full px-4 py-3.5 text-base shadow-lg shadow-omega-green/20"
            >
              {loading ? (
