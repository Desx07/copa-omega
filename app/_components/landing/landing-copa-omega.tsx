...
interface LandingCopaOmegaProps {
  totalPlayers: number;
  totalStars: number;
  totalMatches: number;
...
// Landing de la modalidad Copa Omega (sistema de estrellas). Diseño original sin cambios.
export function LandingCopaOmega({ totalPlayers, totalStars, totalMatches, topPlayers }: LandingCopaOmegaProps) {
  return (
    <>
      {/* ═══ HERO ═══ */}
